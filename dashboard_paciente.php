...
<body>
    ...
    <script>
        ...
        // ========== DADOS DOS ARTIGOS ==========
        var articlesData = {
            'habitos': { title: '7 hábitos para manter o coração saudável', date: '15 de Maio, 2024 • 14 min', content: '<p>Conteúdo do artigo...</p>' },
            'alimentacao': { title: 'Alimentação e saúde cardiovascular', date: '10 de Maio, 2024 • 16 min', content: '<p>Conteúdo do artigo...</p>' },
            'exercicios': { title: 'Exercícios físicos recomendados para cardíacos', date: '05 de Maio, 2024 • 13 min', content: '<p>Conteúdo do artigo...</p>' },
            'pressao': { title: 'Como monitorar sua pressão arterial em casa', date: '01 de Maio, 2024 • 11 min', content: '<p>Conteúdo do artigo...</p>' },
            'tecnologia': { title: 'Tecnologia e saúde: apps para monitoramento cardíaco', date: '28 de Abril, 2024 • 12 min', content: '<p>Conteúdo do artigo...</p>' },
            'diabetes': { title: 'O impacto do diabetes na saúde do coração', date: '20 de Abril, 2024 • 15 min', content: '<p>Conteúdo do artigo...</p>' },
            'colesterol': { title: 'Colesterol: mitos e verdades', date: '15 de Abril, 2024 • 13 min', content: '<p>Conteúdo do artigo...</p>' },
            'insuficiencia': { title: 'Insuficiência cardíaca: sinais de alerta', date: '10 de Abril, 2024 • 14 min', content: '<p>Conteúdo do artigo...</p>' }
        };
        ...
        function loadContent(page) {
            ...
            if (page === 'inicio') {
                ...
                var html = '<div class="info-card"><h3><i class="fas fa-newspaper"></i> Artigos Recentes</h3>';
                Object.keys(articlesData).forEach(function(id) {
                    var a = articlesData[id];
                    html += '<div class="blog-post cursor-pointer" onclick="openArticle(\'' + id + '\')"><div class="blog-title">' + a.title + '</div><div class="blog-date">' + a.date + '</div></div>';
                });
                html += '</div>';
