    ...
    <script>
        ...
        function loadContent(page) {
            ...
            if (page === 'inicio') {
                ...
                var html = '<div class="info-card"><h3><i class="fas fa-book-medical"></i> Educação para a sua saúde</h3><p style="color:#64748b;margin-bottom:16px;">Entenda o diagnóstico, os efeitos no corpo e os cuidados que ajudam no acompanhamento. Estas informações não substituem a consulta.</p>';
                Object.keys(articlesData).forEach(function(id) {
                    var a = articlesData[id];
                    html += '<div class="blog-post cursor-pointer" onclick="openArticle(\'' + id + '\')"><div class="blog-title">' + a.title + '</div><div class="blog-date">' + a.date + '</div><div style="margin-top:8px; font-size:12px; color:#64748b; line-height:1.5;">' + (a.summary || '') + '</div></div>';
                });
                html += '</div>';
