...
<script>
    // Função para renderizar as listas (acessada pelo dashboard.php)
    window.renderConsultas = function() {
        // Garantir que os dados estejam disponíveis
        if (!window.consultas) {
            console.warn('Dados de consultas não disponíveis.');
            return;
        }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Garantir que a aba Pendentes esteja visível
